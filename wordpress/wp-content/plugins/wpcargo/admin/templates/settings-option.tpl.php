<form method="post" action="options.php">
	...
	<?php
		...
		$track_form = is_array( $page_options ) &&  array_key_exists( 'wpcargo_page_settings_track_form', $page_options ) ? $page_options['wpcargo_page_settings_track_form'] : false;
	?>
	<table class="form-table">
		...
		<tr valign="top">
			...
			<td>
				<input type="text" name='wpcargo_option_settings[settings_shipment_ship_logo]' id="image-chooser" value="<?php echo $options['settings_shipment_ship_logo'];?>"> 
			...
			<td>
				<select name='wpcargo_page_settings[wpcargo_page_settings_track_form]'>
					...
					<?php foreach ($pages as $page) { ?>
						<option value="<?php  echo $page->ID; ?>" <?php selected( $track_form, $page->ID ); ?>> <?php echo $page->post_title; ?> </option>
					<?php } ?>
				</select>
				<p style="font-size:12px;"><?php esc_html_e('Select a page to insert', 'wpcargo'); ?> "[wpcargo_trackform]"</p>
		        <?php
		        	if (!empty($track_form)) { ?>
						<a target="_blank" href="post.php?post=<?php echo $track_form; ?>&amp;action=edit" class="button button-secondary pmpro_page_edit">        <?php esc_html_e('Edit Page', 'wpcargo'); ?></a>
						<a target="_blank" href="<?php echo get_page_link($track_form); ?>" class="button button-secondary pmpro_page_view"> <?php esc_html_e('View Page', 'wpcargo'); ?> </a>
					<?php }
                    if (!empty($track_form)) {
