...
class WPCargo{
	...
	*/
	...
	public function barcode_url( $shipment_id, $barcode_size = '', $barcode_type = '', $orientation = '' ){
		require WPCARGO_PLUGIN_PATH.'lib/barcode-generator/vendor/autoload.php';
		$generator 	= new Picqer\Barcode\BarcodeGeneratorPNG();
		$width 		= apply_filters( 'wpcargo_barcode_url_width', 1 );
		$height 	= apply_filters( 'wpcargo_barcode_url_height', 60 );
		return 'data:image/png;base64,'.base64_encode($generator->getBarcode( get_the_title( $shipment_id ), $generator::TYPE_CODE_128, $width, $height ));
	}
	/*
	** Protected Functions
	*/
