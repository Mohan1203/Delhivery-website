...
= 6.9.0 =
- Fixed date and time picker onScroll data change issue
- Update barcode generator library to fix the vulnerability issue

= 6.8.9 =
- Fixed wp-admin package display overlapping
- Fixed Package header label filter hook error
- Fixed error on the export error undefined term index
- Add new additional font "Traditional Chinese Translation" print font option
- Add new filter hook wpcargo_generated_shipment_number to customize generated shipment number
